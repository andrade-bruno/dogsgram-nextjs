...
export default async function ProductPage({ params }: PageProps) {
  ...
  return (
    <div>
      ...
      <p>
        Once you refresh, server's gonna trigger a new bundle for that .html
        file, and you'll see the cached version in browser. The most recent is
        gonna be in .cache folder.{" "}
      </p>
      <p>
        So, if you reload the page before the revalidation period once more,
        you'll se the latest .html file
      </p>
